...
/**
 * 创建 RESTful API 工厂实例
 * @param endpoint - API 端点路径，如 '/articles'
 * @param options - 可选配置 { stringifyTargetKey, transformParams, transformBody }
 * @returns API 对象，含 getList / getOne / create / update / patch / delete / get / post / put / patchRequest / deleteRequest
 */
