...
// 简单 Markdown 渲染（用于评论）
/**
 * 简单 Markdown 渲染（仅支持基础语法，不含代码高亮，用于评论等场景）
 * @param markdown - Markdown 文本
 * @returns 消毒后的 HTML 字符串（仅允许 p/br/strong/em/code/pre/ul/ol/li/blockquote/a/img 标签）
 */
